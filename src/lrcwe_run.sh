...
#MODEL_PATH="../gen_data/model/lswe-cbow-${VEC_NUM}-model.a.${ITER_NUM}.${BELTA_ANT}.${ALPHA_ANT}.${IDX}.bin"
#MODEL_PATH="../gen_data/model/lswe-cbow-${VEC_NUM}-model.s.${ITER_NUM}.${BELTA_SYN}.${ALPHA_SYN}.4.bin"
